...
class UserTestCase(TestCase):
    ...
    def setUp(self):
        ...
        """
        password = "p@ssword"
        h = Hospital.objects.create(name="University of KIMS",
                                    address="Madhapur", state="Telangana", city="Hyderabad",
                                    zipcode="500016")

        h2 = Hospital.objects.create(name="Apollo Hospitals",
        ...
        h3 = Hospital.objects.create(name="Highland Hospital",
                                     ...
                                     zipcode="14620")
        h4 = Hospital.objects.create(name="RIMS",
                                     address="Nanakramguda", state="Telangana", city="Hyderabad",
                                     zipcode="14620")
        h5 = Hospital.objects.create(name="PACE Hospitals",
                                     address="Secunderabad", state="Telangana", city="Hyderabad",
                                     zipcode="14620")
        h6 = Hospital.objects.create(name="Srikar Hospitals",
                                     address="Miyapur", state="Telangana", city="Hyderabad",
                                     zipcode="500000")
        h7 = Hospital.objects.create(name="Apollo Hospitals",
                                    address="HitechCity", state="Telangana", city="Hyderabad",
                                    zipcode="500012")

        h8 = Hospital.objects.create(name="Challa Hospitals",
                                     address="Ameerpet", state="Telangana", city="Hyderabad",
                                     zipcode="500018")
        h9 = Hospital.objects.create(name="RIMS",
                                     address="Nanakramguda", state="Telangana", city="Hyderabad",
                                     zipcode="500039")
